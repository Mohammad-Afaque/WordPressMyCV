...
\cventry
    ...
    {} % Date(s)
    {
      \begin{cvitems} % Description(s)
        ...
        \item {Updated the content according to company's needs.}
        \item {Improved LCP and FCP by optimizing image sizes.}
      \end{cvitems}
    }
%---------------------------------------------------------
...
\cventry
    ...
    {
      \begin{cvitems} % Description(s)
        \item {{\href{https://www.vpix360.com/}Click here {\textbf{VPIX}}}}
        \item {{\href{https://www.postalmethods.com/}Click here {\textbf{Postal Methods}}}}
        \item {{\href{https://www.hamararishta.pk/}Click here {\textbf{Hamara Rishta}}}}
        \item {{\href{https://www.akautocenter.ae/}Click here {\textbf{AK Auto Center}}}}
        \item {{\href{https://www.codingibex.com/}Click here {\textbf{Coding Ibex}}}}
        \item {{\href{https://www.shamsaali.com/}Click here {\textbf{Shamsa Ali (Member of Parliment)}}}}
        \item {{\href{https://www.buneyad.com/}Click here {\textbf{Buneyad}}}}
        \item {{\href{https://www.lhdcarshowroom.co.uk/}Click here {\textbf{The Left Hand Drive Car Showroom)}}}}
      \end{cvitems}
    }
